...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/Users/neel/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/neel/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/neel/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
if [ -f '/Users/neel/Documents/packages/google-cloud-sdk/completion.zsh.inc' ]; then . '/Users/neel/Documents/packages/google-cloud-sdk/completion.zsh.inc'; fi
eval "$(zoxide init zsh)"

# bun completions
[ -s "/Users/neel/.bun/_bun" ] && source "/Users/neel/.bun/_bun"
